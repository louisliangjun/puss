...
static void lua_push_nk_vec2(lua_State* L, struct nk_vec2 v) {
...
static void lua_push_nk_rect(lua_State* L, struct nk_rect v) {
...
static void lua_push_nk_color(lua_State* L, struct nk_color v) {
	lua_createtable(L, 4, 0);
	lua_pushnumber(L, v.r);	lua_rawseti(L, -2, 1);
	lua_pushnumber(L, v.g);	lua_rawseti(L, -2, 2);
	lua_pushnumber(L, v.b);	lua_rawseti(L, -2, 3);
	lua_pushnumber(L, v.a);	lua_rawseti(L, -2, 4);
}
...
static struct nk_text_edit* lua_check_nk_text_edit(lua_State* L, int arg) {
	luaL_argerror(L, arg, "lua_check_nk_text_edit not implement");
	return NULL;
}

static void lua_push_nk_window(lua_State* L, struct nk_window* w) {
	if( w ) {
...
static void lua_push_nk_panel(lua_State* L, struct nk_panel* p) {
	if( w ) {
...
// TODO :
//  some _ref() only used for return value, use multi return
//  or
//  use ref wrap(v), wrap get/set
 
static nk_flags* lua_check_nk_flags_ref(lua_State* L, int arg) {
	luaL_argerror(L, arg, "lua_check_nk_flags_ref not implement");
	return NULL;
}

static int* lua_check_nk_bool_ref(lua_State* L, int arg) {
	luaL_argerror(L, arg, "lua_check_nk_bool_ref not implement");
	return NULL;
}

static int* lua_check_nk_size_ref(lua_State* L, int arg) {
	luaL_argerror(L, arg, "lua_check_nk_size_ref not implement");
	return NULL;
}

static int* lua_check_nk_int_ref(lua_State* L, int arg) {
	luaL_argerror(L, arg, "lua_check_nk_int_ref not implement");
	return NULL;
}

static float* lua_check_nk_float_ref(lua_State* L, int arg) {
	luaL_argerror(L, arg, "lua_check_nk_float_ref not implement");
	return NULL;
}

static double* lua_check_nk_double_ref(lua_State* L, int arg) {
	luaL_argerror(L, arg, "lua_check_nk_double_ref not implement");
	return NULL;
}

static struct nk_color* lua_check_nk_color_ref(lua_State* L, int arg) {
	luaL_argerror(L, arg, "lua_check_nk_color_ref not implement");
	return NULL;
}
...
static struct nk_command_buffer* lua_check_nk_command_buffer(lua_State* L, int arg) {
	luaL_argerror(L, arg, "lua_check_nk_command_buffer not implement");
	return NULL;
}

static void lua_push_nk_command_buffer(lua_State* L, struct nk_command_buffer* b) {
	if( w ) {
...
static struct nk_cursor* lua_check_nk_cursor(lua_State* L, int arg) {
	luaL_argerror(L, arg, "lua_check_nk_cursor not implement");
	return NULL;
}

static struct nk_user_font* lua_check_nk_user_font(lua_State* L, int arg) {
	luaL_argerror(L, arg, "lua_check_nk_user_font not implement");
	return NULL;
}
...
LUA_NK_API_NORET( nk_input_key, lua_check_nk_context(L,1), lua_check_nk_enum(nk_keys,2), lua_toboolean(L,3) )

// NK_API void nk_input_button(struct nk_context*, enum nk_buttons, int x, int y, int down);
LUA_NK_API_NORET( nk_input_button, lua_check_nk_context(L,1), lua_check_nk_enum(nk_buttons,2)
...
LUA_NK_API( lua_push_nk_window, nk_window_find, lua_check_nk_context(L,1), luaL_checkstring(L,2) )
...
LUA_NK_API( lua_push_nk_panel, nk_window_get_panel, lua_check_nk_context(L,1) )
...
LUA_NK_API( lua_pushboolean, nk_window_is_active, lua_check_nk_context(L,1) )
...
LUA_NK_API_NORET( nk_window_collapse, lua_check_nk_context(L,1), luaL_checkstring(L,2), lua_check_nk_enum(nk_collapse_states,3) )

// NK_API void nk_window_collapse_if(struct nk_context*, const char *name, enum nk_collapse_states, int cond);

// NK_API void nk_window_show(struct nk_context*, const char *name, enum nk_show_states);
LUA_NK_API( nk_window_show, lua_check_nk_context(L,1), luaL_checkstring(L,2), lua_check_nk_enum(nk_show_states,3) )
...
LUA_NK_API_NORET( nk_layout_row_begin, lua_check_nk_context(L,1), lua_check_nk_enum(nk_layout_format,2), lua_check_nk_float(L,3), luaL_checkinteger(L,4) )
...
LUA_NK_API_NORET( nk_layout_row, lua_check_nk_context(L,1), lua_check_nk_enum(nk_layout_format,2), lua_check_nk_float(L,3)
		, lua_check_nk_int(L,4), lua_check_nk_float_array(L,5,lua_check_nk_int(L,4)) )
...
LUA_NK_API_NORET( nk_layout_space_begin, lua_check_nk_context(L,1), lua_check_nk_float(L,2) )
...
LUA_NK_API( lua_pushboolean, nk_group_scrolled_offset_begin, lua_check_nk_context(L,1), lua_check_nk_uint_ref(L,2)
...
LUA_NK_API_NORET( nk_list_view_end, lua_check_nk_context(L,1) )
...
LUA_NK_API( lua_pushboolean, nk_tree_push_hashed, lua_check_nk_context(L,1), lua_check_nk_enum(nk_tree_type,2), luaL_checkstring(L,3)
...
LUA_NK_API( lua_pushboolean, nk_tree_image_push_hashed, lua_check_nk_context(L,1), lua_check_nk_enum(nk_tree_type,2)
	, lua_check_nk_image(L,3), luaL_checkstring(L,4), lua_check_nk_enum(nk_collapse_states,5)
...
LUA_NK_API( lua_pushboolean, nk_tree_state_image_push, lua_check_nk_context(L,1), lua_check_nk_enum(nk_tree_type,2)
		, lua_check_nk_image(L,3), luaL_checkstring(L,4), lua_check_nk_enum(nk_collapse_states,5) )
...
LUA_NK_API( lua_pushinteger, nk_widget, lua_check_nk_context(L,1), lua_check_nk_rect_ref(L,1), lua_check_nk_context(L,2) )

// NK_API enum nk_widget_layout_states nk_widget_fitting(struct nk_rect*, struct nk_context*, struct nk_vec2);
LUA_NK_API( lua_pushinteger, nk_widget_fitting, lua_check_nk_context(L,1), lua_check_nk_rect_ref(L,1), lua_check_nk_context(L,2), lua_check_nk_rect(L,3) )
...
LUA_NK_API( lua_pushboolean, nk_widget_is_mouse_clicked, lua_check_nk_context(L,1), lua_check_nk_enum(nk_buttons,2) )

// NK_API int nk_widget_has_mouse_click_down(struct nk_context*, enum nk_buttons, int down);
LUA_NK_API( lua_pushboolean, nk_widget_has_mouse_click_down, lua_check_nk_context(L,1), lua_check_nk_enum(nk_buttons,2), lua_toboolean(L,3) )
...
LUA_NK_API_NORET( nk_value_uint, lua_check_nk_context(L,1), luaL_checkstring(L,2), (unsigned int)luaL_checkinteger(L,3) )
...
LUA_NK_API( lua_pushboolean, nk_button_label, lua_check_nk_context(L,1), luaL_checklstring(L,2) )
...
LUA_NK_API( lua_pushboolean, nk_button_symbol, lua_check_nk_context(L,1), lua_check_nk_enum(nk_symbol_type,2) )
...
LUA_NK_API( lua_pushboolean, nk_button_symbol_label, lua_check_nk_context(L,1), lua_check_nk_image(L,2) )

// NK_API int nk_button_symbol_text(struct nk_context*, enum nk_symbol_type, const char*, int, nk_flags alignment);
LUA_NK_API( lua_pushboolean, nk_button_symbol_text, lua_check_nk_context(L,1), lua_check_nk_enum(nk_symbol_type,2), luaL_checkstring(L,3), lua_check_nk_flags(L,4) )
...
LUA_NK_API( lua_pushboolean, nk_button_text_styled, lua_check_nk_context(L,1), lua_check_nk_style_button_ref(L,2)
...
LUA_NK_API( lua_pushboolean, nk_button_label_styled, lua_check_nk_context(L,1), lua_check_nk_style_button_ref(L,2), luaL_checkstring(L,3) )

// NK_API int nk_button_symbol_styled(struct nk_context*, const struct nk_style_button*, enum nk_symbol_type);
LUA_NK_API( lua_pushboolean, nk_button_symbol_styled, lua_check_nk_context(L,1), lua_check_nk_style_button_ref(L,2), lua_check_nk_enum(nk_symbol_type,3) )

// NK_API int nk_button_image_styled(struct nk_context*, const struct nk_style_button*, struct nk_image img);
LUA_NK_API( lua_pushboolean, nk_button_image_styled, lua_check_nk_context(L,1), lua_check_nk_style_button_ref(L,2), lua_check_nk_image(L,3) )
...
LUA_NK_API( lua_pushboolean, nk_button_symbol_text_styled, lua_check_nk_context(L,1), lua_check_nk_style_button_ref(L,2), lua_check_nk_enum(nk_symbol_type,3)
...
LUA_NK_API( lua_pushboolean, nk_button_symbol_label_styled, lua_check_nk_context(L,1), lua_check_nk_style_button_ref(L,2)
	, lua_check_nk_enum(nk_symbol_type,3), luaL_checkstring(L,4), lua_check_nk_flags(L,5) )
...
LUA_NK_API( lua_pushboolean, nk_button_image_label_styled, lua_check_nk_context(L,1), lua_check_nk_style_button_ref(L,2)
...
LUA_NK_API( lua_pushboolean, nk_button_image_text_styled, lua_check_nk_context(L,1), lua_check_nk_style_button_ref(L,2), lua_check_nk_image(L,3)
		, luaL_checkstring(L,4), lua_check_nk_text_len(L,5), lua_check_nk_flags(L,6) )

// NK_API void nk_button_set_behavior(struct nk_context*, enum nk_button_behavior);
LUA_NK_API_NORET( nk_button_set_behavior, lua_check_nk_context(L,1), lua_check_nk_enum(nk_button_behavior,2) )

// NK_API int nk_button_push_behavior(struct nk_context*, enum nk_button_behavior);
LUA_NK_API( lua_pushboolean, nk_button_push_behavior, lua_check_nk_context(L,1), lua_check_nk_enum(nk_button_behavior,2) )
...
LUA_NK_API( lua_pushinteger, nk_check_flags_label, lua_check_nk_context(L,1), luaL_checkstring(L,2), lua_check_nk_flags(L,3), (unsigned int)luaL_checkinteger(L,4) )
...
LUA_NK_API( lua_pushinteger, nk_check_flags_text, lua_check_nk_context(L,1), luaL_checkstring(L,2), lua_check_nk_text_len(L,3)
	, lua_check_nk_flags(L,4), (unsigned int)luaL_checkinteger(L,5) )

// NK_API int nk_checkbox_label(struct nk_context*, const char*, int *active);
LUA_NK_API( lua_pushboolean, nk_checkbox_label, lua_check_nk_context(L,1), luaL_checkstring(L,2), lua_check_nk_bool_ref(L,3) )

// NK_API int nk_checkbox_text(struct nk_context*, const char*, int, int *active);
LUA_NK_API( lua_pushboolean, nk_checkbox_text, lua_check_nk_context(L,1), luaL_checkstring(L,2), lua_check_nk_text_len(L,3), lua_check_nk_bool_ref(L,4) )

// NK_API int nk_checkbox_flags_label(struct nk_context*, const char*, unsigned int *flags, unsigned int value);
LUA_NK_API( lua_pushboolean, nk_checkbox_flags_label, lua_check_nk_context(L,1), luaL_checkstring(L,2), lua_check_nk_flags_ref(L,3), (unsigned int)luaL_checkinteger(L,4) )

// NK_API int nk_checkbox_flags_text(struct nk_context*, const char*, int, unsigned int *flags, unsigned int value);
LUA_NK_API( lua_pushboolean, nk_checkbox_flags_text, lua_check_nk_context(L,1), luaL_checkstring(L,2), lua_check_nk_text_len(L,3)
	, lua_check_nk_flags_ref(L,4), (unsigned int)luaL_checkinteger(L,5) )

// NK_API int nk_radio_label(struct nk_context*, const char*, int *active);
LUA_NK_API( lua_pushboolean, nk_radio_label, lua_check_nk_context(L,1), luaL_checkstring(L,2), lua_check_nk_bool_ref(L,3) )

// NK_API int nk_radio_text(struct nk_context*, const char*, int, int *active);
LUA_NK_API( lua_pushboolean, nk_radio_text, lua_check_nk_context(L,1), luaL_checkstring(L,2), lua_check_nk_text_len(L,3), lua_check_nk_bool_ref(L,4) )
...
LUA_NK_API( lua_pushboolean, nk_selectable_label, lua_check_nk_context(L,1), luaL_checkstring(L,2), lua_check_nk_flags(L,3), lua_check_nk_bool_ref(L,4) )

// NK_API int nk_selectable_text(struct nk_context*, const char*, int, nk_flags align, int *value);
LUA_NK_API( lua_pushboolean, nk_selectable_text, lua_check_nk_context(L,1), luaL_checkstring(L,2), lua_check_nk_text_len(L,3), lua_check_nk_flags(L,4), lua_check_nk_bool_ref(L,4) )

// NK_API int nk_selectable_image_label(struct nk_context*,struct nk_image,  const char*, nk_flags align, int *value);
LUA_NK_API( lua_pushboolean, nk_selectable_image_label, lua_check_nk_context(L,1), lua_check_nk_image(L,2), luaL_checkstring(L,3), lua_check_nk_flags(L,4), lua_check_nk_bool_ref(L,5) )

// NK_API int nk_selectable_image_text(struct nk_context*,struct nk_image, const char*, int, nk_flags align, int *value);
LUA_NK_API( lua_pushboolean, nk_selectable_image_text, lua_check_nk_context(L,1), lua_check_nk_image(L,2)
	, luaL_checkstring(L,3), lua_check_nk_text_len(L,4)
	, lua_check_nk_flags(L,5), lua_check_nk_bool_ref(L,6) )
...
LUA_NK_API( lua_pushboolean, nk_slider_float, lua_check_nk_context(L,1), lua_check_nk_float(L,2)
	, lua_check_nk_float_ref(L,3), lua_check_nk_float(L,4), lua_check_nk_float(L,5) )

// NK_API int nk_slider_int(struct nk_context*, int min, int *val, int max, int step);
LUA_NK_API( lua_pushboolean, nk_slider_int, lua_check_nk_context(L,1), lua_check_nk_int(L,2)
	, lua_check_nk_int_ref(L,3), lua_check_nk_int(L,4), lua_check_nk_int(L,5) )

// NK_API int nk_progress(struct nk_context*, nk_size *cur, nk_size max, int modifyable);
LUA_NK_API( lua_pushboolean, nk_slider_int, lua_check_nk_context(L,1), lua_check_nk_size_ref(L,2), lua_check_nk_size(L,3), lua_toboolean(L,4) )
...
LUA_NK_API( lua_push_nk_color, nk_color_picker, lua_check_nk_context(L,1), lua_check_nk_size(L,2), lua_check_nk_size(L,3), lua_toboolean(L,4) )

// NK_API int nk_color_pick(struct nk_context*, struct nk_color*, enum nk_color_format);
LUA_NK_API( lua_pushboolean, nk_color_pick, lua_check_nk_context(L,1), lua_check_nk_color_ref(L,2), lua_check_nk_enum(nk_color_format,3) )

// NK_API void nk_property_int(struct nk_context*, const char *name, int min, int *val, int max, int step, float inc_per_pixel);
LUA_NK_API_NORET( nk_property_int, lua_check_nk_context(L,1), luaL_checkstring(L,2), lua_check_nk_int(L,3)
	, lua_check_nk_int_ref(L,4), lua_check_nk_int(L,5), lua_check_nk_int(L,6), lua_check_nk_float(L,7) )

// NK_API void nk_property_float(struct nk_context*, const char *name, float min, float *val, float max, float step, float inc_per_pixel);
LUA_NK_API_NORET( nk_property_float, lua_check_nk_context(L,1), luaL_checkstring(L,2), lua_check_nk_float(L,3)
	, lua_check_nk_float_ref(L,4), lua_check_nk_float(L,5), lua_check_nk_float(L,6), lua_check_nk_float(L,7) )

// NK_API void nk_property_double(struct nk_context*, const char *name, double min, double *val, double max, double step, float inc_per_pixel);
LUA_NK_API_NORET( nk_property_double, lua_check_nk_context(L,1), luaL_checkstring(L,2), lua_check_nk_double(L,3)
	, lua_check_nk_double_ref(L,4), lua_check_nk_double(L,5), lua_check_nk_double(L,6), lua_check_nk_float(L,7) )
...
LUA_NK_API( lua_pushboolean, nk_chart_begin, lua_check_nk_context(L,1), lua_check_nk_enum(nk_chart_type,2), lua_check_nk_int(L,3)
...
LUA_NK_API( lua_pushboolean, nk_chart_begin_colored, lua_check_nk_context(L,1), lua_check_nk_enum(nk_chart_type,2), lua_check_nk_color(L,3)
	, lua_check_nk_color(L,4), lua_check_nk_int(L,5), lua_check_nk_float(L,6), lua_check_nk_float(L,7) )

// NK_API void nk_chart_add_slot(struct nk_context *ctx, const enum nk_chart_type, int count, float min_value, float max_value);
LUA_NK_API_NORET( nk_chart_add_slot, lua_check_nk_context(L,1), lua_check_nk_enum(nk_chart_type,2), lua_check_nk_int(L,3)
	, lua_check_nk_float(L,4), lua_check_nk_float(L,5) )

// NK_API void nk_chart_add_slot_colored(struct nk_context *ctx, const enum nk_chart_type, struct nk_color, struct nk_color active, int count, float min_value, float max_value);
LUA_NK_API_NORET( nk_chart_add_slot_colored, lua_check_nk_context(L,1), lua_check_nk_enum(nk_chart_type,2), lua_check_nk_color(L,3)
	, lua_check_nk_color(L,4), ilua_check_nk_int(L,5), lua_check_nk_float(L,6), lua_check_nk_float(L,7) )
...
LUA_NK_API_NORET( nk_plot, lua_check_nk_context(L,1), lua_check_nk_enum(nk_chart_type,2)
	, lua_check_nk_float_array(L,3,lua_check_nk_int(L,4)+lua_check_nk_int(L,5))
	, lua_check_nk_int(L,4), lua_check_nk_int(L,5) )

// NK_API void nk_plot_function(struct nk_context*, enum nk_chart_type, void *userdata, float(*value_getter)(void* user, int index), int count, int offset);
// LUA_NK_API_NORET( nk_plot_function, lua_check_nk_context(L,1), lua_check_nk_enum(nk_chart_type,2), lua_topointer(L,3), float(*value_getter)(void* user, int index), lua_check_nk_int(L,5), lua_check_nk_int(L,6) )


// NK_API int nk_popup_begin(struct nk_context*, enum nk_popup_type, const char*, nk_flags, struct nk_rect bounds);
LUA_NK_API( lua_pushboolean, nk_popup_begin, lua_check_nk_context(L,1), lua_check_nk_enum(nk_popup_type,2), lua_checkstring(L,3), lua_check_nk_flags(L,4), lua_check_nk_rect(L,5) )
...
// LUA_NK_API( lua_pushinteger, nk_combo, lua_check_nk_context(L,1), const char **items, int count, int selected, int item_height, lua_check_nk_vec2(L,3) )
...
// LUA_NK_API_NORET( nk_combobox, lua_check_nk_context(L,1), const char **items, int count, int *selected, int item_height, lua_check_nk_vec2(L,3) )

// NK_API void nk_combobox_string(struct nk_context*, const char *items_separated_by_zeros, int *selected, int count, int item_height, struct nk_vec2 size);
LUA_NK_API_NORET( nk_combobox_string, lua_check_nk_context(L,1), luaL_checkstring(L,2), lua_check_nk_int_ref(L,3)
	, lua_check_nk_int(L,4), lua_check_nk_int(L,5), lua_check_nk_vec2(L,6) )

// NK_API void nk_combobox_separator(struct nk_context*, const char *items_separated_by_separator, int separator,int *selected, int count, int item_height, struct nk_vec2 size);
LUA_NK_API_NORET( nk_combobox_separator, lua_check_nk_context(L,1), luaL_checkstring(L,2), lua_check_nk_char(L,3)
	, lua_check_nk_int_ref(L,4), lua_check_nk_int(L,5), lua_check_nk_int(L,6), lua_check_nk_vec2(L,7) )
...
LUA_NK_API( lua_pushboolean, nk_combo_begin_symbol, lua_check_nk_context(L,1), lua_check_nk_enum(nk_symbol_type,2),  lua_check_nk_vec2(L,3) )

// NK_API int nk_combo_begin_symbol_label(struct nk_context*, const char *selected, enum nk_symbol_type, struct nk_vec2 size);
LUA_NK_API( lua_pushboolean, nk_combo_begin_symbol_label, lua_check_nk_context(L,1), luaL_checkstring(L,2), lua_check_nk_enum(nk_symbol_type,3), lua_check_nk_vec2(L,4) )
...
LUA_NK_API( lua_pushboolean, nk_combo_begin_symbol_text, lua_check_nk_context(L,1), luaL_checkstring(L,2), lua_check_nk_text_len(L,3)
	, lua_check_nk_enum(nk_symbol_type,4), lua_check_nk_vec2(L,5) )
...
LUA_NK_API( lua_pushboolean, nk_combo_item_symbol_label, lua_check_nk_context(L,1), lua_check_nk_enum(nk_symbol_type,2), luaL_checkstring(L,3), lua_check_nk_flags(L,4) )

// NK_API int nk_combo_item_symbol_text(struct nk_context*, enum nk_symbol_type, const char*, int, nk_flags alignment);
LUA_NK_API( lua_pushboolean, nk_combo_item_symbol_text, lua_check_nk_context(L,1), lua_check_nk_enum(nk_symbol_type,2), luaL_checkstring(L,3), lua_check_nk_text_len(L,4), lua_check_nk_flags(L,5) )
...
LUA_NK_API( lua_pushboolean, nk_contextual_item_symbol_label, lua_check_nk_context(L,1), lua_check_nk_enum(nk_symbol_type,2), luaL_checkstring(L,3), lua_check_nk_flags(L,4) )

// NK_API int nk_contextual_item_symbol_text(struct nk_context*, enum nk_symbol_type, const char*, int, nk_flags alignment);
LUA_NK_API( lua_pushboolean, nk_contextual_item_symbol_text, lua_check_nk_context(L,1), lua_check_nk_enum(nk_symbol_type,2), luaL_checkstring(L,3), lua_check_nk_text_len(L,4), lua_check_nk_flags(L,5) )
...
LUA_NK_API( lua_pushboolean, nk_menu_begin_image_text, lua_check_nk_context(L,1), luaL_checkstring(L,2), ua_check_nk_text_len(L,3)
...
LUA_NK_API( lua_pushboolean, nk_menu_begin_symbol, lua_check_nk_context(L,1), luaL_checkstring(L,2), lua_check_nk_enum(nk_symbol_type,3), lua_check_nk_vec2(L,4) )
...
LUA_NK_API( lua_pushboolean, nk_menu_begin_symbol_text, lua_check_nk_context(L,1), luaL_checkstring(L,2), lua_check_nk_text_len(L,3)
	, lua_check_nk_flags(L,4), lua_check_nk_enum(nk_symbol_type,5), lua_check_nk_vec2(L,6) )
...
LUA_NK_API( lua_pushboolean, nk_menu_item_symbol_text, lua_check_nk_context(L,1), lua_check_nk_enum(nk_symbol_type,2), luaL_checkstring(L,3), lua_check_nk_text_len(L,4), lua_check_nk_flags(L,5) )

// NK_API int nk_menu_item_symbol_label(struct nk_context*, enum nk_symbol_type, const char*, nk_flags alignment);
LUA_NK_API( lua_pushboolean, nk_menu_item_symbol_label, lua_check_nk_context(L,1), lua_check_nk_enum(nk_symbol_type,2), luaL_checkstring(L,3), lua_check_nk_flags(L,4) )
...
LUA_NK_API_NORET( nk_style_from_table, lua_check_nk_context(L,1), lua_check_nk_color_ref(L,2) )

// NK_API void nk_style_load_cursor(struct nk_context*, enum nk_style_cursor, const struct nk_cursor*);
LUA_NK_API_NORET( nk_style_load_cursor, lua_check_nk_context(L,1), lua_check_nk_enum(nk_style_cursor,2), lua_check_nk_cursor(L,3) )

// NK_API void nk_style_load_all_cursors(struct nk_context*, struct nk_cursor*);
LUA_NK_API_NORET( nk_style_load_all_cursors, lua_check_nk_context(L,1), lua_check_nk_cursor(L,2) )

// NK_API const char* nk_style_get_color_by_name(enum nk_style_colors);
LUA_NK_API( lua_pushstring, nk_style_get_color_by_name, lua_check_nk_enum(nk_style_colors,1) )
...
LUA_NK_API( lua_pushboolean, nk_style_set_cursor, lua_check_nk_context(L,1), lua_check_nk_enum(nk_style_cursor,2) )
...
LUA_NK_API_NORET( nk_buffer_init_default, struct nk_buffer*) )
